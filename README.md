...
```ts
import { ChatDate } from 'greatefue-datewizard';
```

2. Call the function(s)

```ts
var i = ChatDate("2020-01-01");
```


### Note

<!-- <p>The value passed must be an interger (number).</p>
<p>The value returned is an integer (number).</p> -->
...
#   g r e a t e f u e - d a t e w i z a r d  
 